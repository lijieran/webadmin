				...
				<div class="row-fluid">
					...
					<!-- 	<div class="alert alert-block alert-success">
						...
						<form class="form-horizontal margin-none" id="validateSubmitForm"
							method="post" autocomplete="off" action="${ctx }/scheduling/departmentUpdate">
							...
							<input type="hidden" id="id" name="id"  value="${entity.id }"/>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="alias" name="alias" value="${entity.alias }"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="text" name="remarks" value="${entity.remarks }"/>
									</div>
								</div>
