		...
		<div class="page-content">
					...
					<div class="row-fluid">
						<div class="span12">
							...
							method="get" autocomplete="off" action="${ctx }/menu/save" />
								...
								<div class="control-group">
									...
									<div class="controls">
										<input class="easyui-combotree" name="parentId"  value="122" data-options="url:'${ ctxStatic}/tree_data1.json',method:'get'" >
									</div>
								</div>
